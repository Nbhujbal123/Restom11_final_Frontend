...
const Signup: React.FC<SignupProps> = ({ onClose, onSwitchToLogin, onSignup }) => {
  ...
  // Show full-screen loading overlay during OTP verification (account creation)
  ...
  const handleOTPVerify = async (otp: string) => {
    ...
    try {
      ...
      // Navigate to menu instead of login
      navigate('/menu')
  ...
  // Show full-screen loading overlay during OTP verification
  if (isVerifying) {
    return (
      <LoadingSpinner 
        fullScreen={true} 
